...
public class SARS2DefaultSequenceReadsValidator implements SequenceReadsValidator<SARS2> {
	...
	protected List<ValidationResult> validateTrimmedPositions(SequenceReads<SARS2> seqReads, Collection<String> includeGenes) {
		List<ValidationResult> results = new ArrayList<>();
	...
	protected List<ValidationResult> validateNoMissingPositions(SequenceReads<SARS2> seqReads, Collection<String> includeGenes) {
		List<ValidationResult> results = new ArrayList<>();
		List<OneCodonReadsCoverage<SARS2>> crcs = seqReads.getCodonReadsCoverage(includeGenes);
		if (crcs.isEmpty()) {
			return results;
